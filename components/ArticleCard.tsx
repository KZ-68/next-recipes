...
const ArticleCard:React.FC<ArticleCardProps> = ({article}) => {
    ...
    return (
        <div className='group border border-slate-500 dark:bg-white p-6 rounded-md cursor-pointer hover:translate-y-2 duration-300 md:h-full' key={article.id}>
            {/* Titre de l'article */}
            ...
            {/* Texte de l'article */}
            <p className='line-clamp-4 py-1 my-4 text-sm text-black '>{article.text}</p>
