    ...
    <>
        ...
        <div className='flex flex-col my-6 py-8 px-6 mx-80 rounded-lg bg-slate-800'>
            <form className='flex flex-col gap-6 py-8 px-6 rounded-2xl' action={formAction} id="signup-form">
                ...
                <input className='py-3 px-2 rounded-lg' type='text' name="recipe-title" id="recipe-title" value={recipe?.title} />
                <label className='text-white text-2xl' htmlFor="text">Instruction : </label>
                <input className='py-3 px-2 rounded-lg' type='text' name="recipe-instruction" id="recipe-instruction" value={recipe?.instruction}/>
                <label className='text-white text-2xl' htmlFor="title">Slug : </label>
                <input className='py-3 px-2 rounded-lg' type='text' name="recipe-slug" id="recipe-slug" value={recipe?.slug}/>
                <label className='text-white text-2xl' htmlFor="duration">Duration : </label>
                <input className='py-3 px-2 rounded-lg' type='number' min="1" max="1000" name="recipe-duration" id="recipe-duration" value={recipe?.duration} />
                <label className='text-white text-2xl' htmlFor="rating">Rating : </label>
                <input className='py-3 px-2 rounded-lg' type='number' min="0" max="5" name="recipe-rating" id="recipe-rating" value={recipe?.rating}/>
                <fieldset>
